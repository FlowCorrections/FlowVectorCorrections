...
//_____________________________________________________________________
void QnCorrectionsSteps::RotateQvec(QnCorrectionsQnVector* QvectorIn, QnCorrectionsQnVector* QvectorOut, QnCorrectionsHistograms* inputHistos, Int_t bin, Int_t minHar, Int_t maxHar, Int_t alignmentHarmonic) {
  ...
  //
    ...
    for(Int_t ih=minHar; ih<=maxHar; ++ih) {QvectorOut->SetQnVectorStatus(ih, QnCorrectionsConstants::kAlignment);}
    ...
    for(Int_t ih=minHar; ih<=maxHar; ++ih) {
        ...
        QvectorOut->SetQnVectorStatus(ih, QnCorrectionsConstants::kAlignment);
    }
