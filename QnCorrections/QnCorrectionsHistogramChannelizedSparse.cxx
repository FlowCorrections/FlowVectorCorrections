...
/// \cond CLASSIMP
ClassImp(QnCorrectionsHistogramChannelizedSparse);
/// \endcond

/// Default constructor
QnCorrectionsHistogramChannelizedSparse::QnCorrectionsHistogramChannelizedSparse() :
...
QnCorrectionsHistogramChannelizedSparse::QnCorrectionsHistogramChannelizedSparse(const char *name,
      const char *title,
...
Bool_t QnCorrectionsHistogramChannelizedSparse::CreateChannelizedHistogram(TList *histogramList, const Bool_t *bUsedChannel) {
...
Long64_t QnCorrectionsHistogramChannelizedSparse::GetBin(const Float_t *variableContainer, Int_t nChannel) {
...
Bool_t QnCorrectionsHistogramChannelizedSparse::BinContentValidated(Long64_t) {
...
Float_t QnCorrectionsHistogramChannelizedSparse::GetBinContent(Long64_t bin) {
...
Float_t QnCorrectionsHistogramChannelizedSparse::GetBinError(Long64_t bin) {
...
void QnCorrectionsHistogramChannelizedSparse::Fill(const Float_t *variableContainer, Int_t nChannel, Float_t weight) {
