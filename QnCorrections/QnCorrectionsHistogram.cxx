/// \file QnCorrectionsHistogram.cxx
...
/// \cond CLASSIMP
ClassImp(QnCorrectionsHistogram);
/// \endcond

/// Default constructor
QnCorrectionsHistogram::QnCorrectionsHistogram() :
...
QnCorrectionsHistogram::QnCorrectionsHistogram(const char *name,
      const char *title,
...
Bool_t QnCorrectionsHistogram::CreateHistogram(TList *histogramList) {
...
Long64_t QnCorrectionsHistogram::GetBin(const Float_t *variableContainer) {
...
Bool_t QnCorrectionsHistogram::BinContentValidated(Long64_t) {
...
Float_t QnCorrectionsHistogram::GetBinContent(Long64_t bin) {
...
Float_t QnCorrectionsHistogram::GetBinError(Long64_t bin) {
...
void QnCorrectionsHistogram::Fill(const Float_t *variableContainer, Float_t weight) {
