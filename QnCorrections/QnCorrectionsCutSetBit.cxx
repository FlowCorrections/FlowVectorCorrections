 ...
 *                                                                                                *
 **************************************************************************************************/
/// \file QnCorrectionsCutSetBit.cxx
...
/// \cond CLASSIMP
ClassImp(QnCorrectionsCutSetBit);
/// \endcond

/// Default constructor
QnCorrectionsCutSetBit::QnCorrectionsCutSetBit() : QnCorrectionsCutsBase() {
  fBitMask = 0x00000000;
...
QnCorrectionsCutSetBit::QnCorrectionsCutSetBit(const QnCorrectionsCutSetBit &cut) :
    QnCorrectionsCutsBase(cut) {
...
QnCorrectionsCutSetBit::QnCorrectionsCutSetBit(Int_t varId, Int_t bitNo, Bool_t set) :
    QnCorrectionsCutsBase(varId) {
...
QnCorrectionsCutSetBit::~QnCorrectionsCutSetBit() {
}
