...
/// \date Jan 25, 2016
class QnCorrectionsCutSetBit: public QnCorrectionsCutsBase {

 public:
  QnCorrectionsCutSetBit();
  QnCorrectionsCutSetBit(const QnCorrectionsCutSetBit &cut);
...
/// \cond CLASSIMP
  ClassDef(QnCorrectionsCutSetBit, 1);
/// \endcond
};
