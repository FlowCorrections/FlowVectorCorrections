...
/// \cond CLASSIMP
ClassImp(QnCorrectionsHistogramSparse);
/// \endcond

/// Default constructor
QnCorrectionsHistogramSparse::QnCorrectionsHistogramSparse() :
...
QnCorrectionsHistogramSparse::QnCorrectionsHistogramSparse(const char *name,
      const char *title,
...
Bool_t QnCorrectionsHistogramSparse::CreateHistogram(TList *histogramList) {
...
Bool_t QnCorrectionsHistogramSparse::BinContentValidated(Long64_t) {
...
Float_t QnCorrectionsHistogramSparse::GetBinContent(Long64_t bin) {
...
Float_t QnCorrectionsHistogramSparse::GetBinError(Long64_t bin) {
