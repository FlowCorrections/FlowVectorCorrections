...
public:
  ...
  const QnCorrectionsQnVector *GetDetectorQnVector(const char *subdetector, const char *expectedstep = "latest", const char *altstep = "latest") const;
...
/// \cond CLASSIMP
  ClassDef(QnCorrectionsManager, 5);
/// \endcond
};
